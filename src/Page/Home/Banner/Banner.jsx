...
const Banner = () => {
    return (
        ...
        <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
            <SwiperSlide>
                <div className="hero min-h-screen" style={{ backgroundImage: `url(${img})`,backgroundSize: "cover", backgroundPosition: "center" }}  >
                    <div className="hero-overlay bg-opacity-60"></div>
                    <div className="hero-content text-center text-slate-50">
                        <div className="max-w-2xl">
                            <h1 className="mb-5 text-7xl font-bold">Experience the Thrill of Sports</h1>
            ...
            <SwiperSlide>
                <div className="hero min-h-screen" style={{ backgroundImage: `url(${img1})`,backgroundSize: "cover", backgroundPosition: "center" }}  >
                    <div className="hero-overlay bg-opacity-60"></div>
                    <div className="hero-content text-center text-slate-50">
                        <div className="max-w-2xl">
            ...
            <SwiperSlide>
                <div className="hero min-h-screen" style={{ backgroundImage: `url(${img2})`,backgroundSize: "cover", backgroundPosition: "center" }}  >
                    <div className="hero-overlay bg-opacity-60"></div>
                    <div className="hero-content text-center text-slate-50">
                        <div className="max-w-2xl">
                            <h1 className="mb-5 text-7xl font-bold">Join Our Winning Team</h1>
